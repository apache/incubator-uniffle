...
public class RssMRConfig {
  ...
  public static final String RSS_CLIENT_READ_FILTER_MINMAX_MAX_SEGMENTS =
      MR_RSS_CONFIG_PREFIX + RssClientConfig.RSS_CLIENT_READ_FILTER_MINMAX_MAX_SEGMENTS;
  public static final int RSS_CLIENT_READ_FILTER_MINMAX_MAX_SEGMENTS_DEFAULT_VALUE =
