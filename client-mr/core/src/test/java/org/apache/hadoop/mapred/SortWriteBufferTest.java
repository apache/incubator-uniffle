...
public class SortWriteBufferTest {
  ...
  public void testReadWrite() throws IOException {
    ...
    SortWriteBuffer<BytesWritable, BytesWritable> buffer =
        new SortWriteBuffer<BytesWritable, BytesWritable>(
            1, WritableComparator.get(BytesWritable.class), 1024L, false, keySerializer, valSerializer, null);
    ...
    buffer =
        new SortWriteBuffer<BytesWritable, BytesWritable>(
            1, WritableComparator.get(BytesWritable.class), 528L, false, keySerializer, valSerializer, null);
  ...
  public void testSortBufferIterator() throws IOException {
    ...
    SortWriteBuffer<Text, IntWritable> buffer =
        new SortWriteBuffer<Text, IntWritable>(1, null, 3072, false, keySerializer, valueSerializer, null);
