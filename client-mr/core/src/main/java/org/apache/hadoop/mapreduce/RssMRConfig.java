...
public class RssMRConfig {
  ...
  public static final String RSS_REMOTE_MERGE_ENABLE = MR_CONFIG_PREFIX + RssClientConfig.RSS_REMOTE_MERGE_ENABLE;
  public static final boolean RSS_REMOTE_MERGE_ENABLE_DEFAULT = false;
  public static final String RSS_MERGED_BLOCK_SZIE = MR_CONFIG_PREFIX + RssClientConfig.RSS_MERGED_BLOCK_SZIE;
  public static final int RSS_MERGED_BLOCK_SZIE_DEFAULT = RssClientConfig.RSS_MERGED_BLOCK_SZIE_DEFAULT;
  public static final String RSS_MERGED_WRITE_MAX_RECORDS = MR_RSS_CONFIG_PREFIX + "rm.write.max.records";
