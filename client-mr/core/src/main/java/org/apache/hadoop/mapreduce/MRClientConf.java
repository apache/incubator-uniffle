...
public class MRClientConf extends RssBaseConf {
  ...
  public static final ConfigOption<Integer> RSS_CLIENT_RETRY_MAX =
      ConfigOptions.key("mapreduce.rss.client.retry.max")
          .intType()
          .defaultValue(50)
          .withDescription("");
  ...
  public static final ConfigOption<Integer> RSS_DATA_REPLICA_WRITE =
      ConfigOptions.key("mapreduce.rss.data.replica.write")
          .intType()
          .defaultValue(1)
          .withDescription("");

  public static final ConfigOption<Integer> RSS_DATA_REPLICA_READ =
      ConfigOptions.key("mapreduce.rss.data.replica.read")
          .intType()
          .defaultValue(1)
          .withDescription("");
  ...
  public static final ConfigOption<Integer> RSS_CLIENT_BITMAP_NUM =
      ConfigOptions.key("mapreduce.rss.client.bitmap.num")
          .intType()
          .defaultValue(1)
          .withDescription("");
  ...
  public static final ConfigOption<String> RSS_CLIENT_READ_BUFFER_SIZE =
      ConfigOptions.key("mapreduce.rss.client.read.buffer.size")
          ...
          .defaultValue("14m")
          .withDescription(
              "When the size of read buffer reaches the half of JVM region (i.e., 32m),it will incur humongous allocation, so we set it to 14m. ");
