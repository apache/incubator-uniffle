...
import org.apache.tez.runtime.library.common.readers.RssUnorderedKVReader;
...
public class RssUnorderedKVInput extends AbstractLogicalInput {
  ...
  private RssUnorderedKVReader kvReader;
  ...
  public void handleEvents(List<Event> inputEvents) throws IOException {
    LOG.info("handleEvents:{}", inputEvents);
  ...
  @SuppressWarnings("rawtypes")
  private RssUnorderedKVReader createReader(TezCounter inputRecordCounter, CompressionCodec codec,
                                         int ifileBufferSize, boolean ifileReadAheadEnabled, int ifileReadAheadLength)
      throws IOException {
    return new RssUnorderedKVReader(rssShuffleManager, conf, codec, ifileReadAheadEnabled,
