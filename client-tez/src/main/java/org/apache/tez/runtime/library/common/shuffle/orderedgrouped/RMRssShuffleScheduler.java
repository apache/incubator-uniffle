...
// Although RMRssShuffleScheduler is extended from ShuffleScheduler, it is only used to handle DME events.
// Because the protobuf-java version of tez is different from uniffle, it is not convenient to parse DME events.
// It means there is no need to start RMRssShuffleScheduler.
public class RMRssShuffleScheduler extends ShuffleScheduler {

  private RMRssShuffle rssShuffle;

  public RMRssShuffleScheduler(InputContext inputContext, Configuration conf, int numberOfInputs,
                               ...
                               boolean ifileReadAhead, int ifileReadAheadLength, String srcNameTrimmed,
                               RMRssShuffle rssShuffle) throws IOException {
