...
public class RssDAGAppMaster extends DAGAppMaster {
  ...
  private final String rssConfFileLocalResourceName = "rss_conf.xml";
  ...
  public RssDAGAppMaster(ApplicationAttemptId applicationAttemptId,
  ...
  @Override
  public String submitDAGToAppMaster(DAGProtos.DAGPlan dagPlan,
