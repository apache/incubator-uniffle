...
public class RssSortedGroupedMergedInputTest {
  ...
  public void testSimple() throws Exception {
    ...
    RssOrderedGroupedMergedKVInput input = new RssOrderedGroupedMergedKVInput(mockContext, sInputs);
  ...
  public void testSkippedKey() throws Exception {
    ...
    RssOrderedGroupedMergedKVInput input = new RssOrderedGroupedMergedKVInput(createMergedInputContext(), sInputs);
