...
public class WriteBufferManagerTest {
	...
	public void testWriteException() throws IOException, InterruptedException {
		...
		WriteBufferManager<BytesWritable, BytesWritable> bufferManager = new WriteBufferManager(tezTaskAttemptID, maxMemSize, appId,
	...
	public void testCommitBlocksWhenMemoryShuffleDisabled() throws IOException, InterruptedException {
		...
		assertTrue(bufferManager.getWaitSendBuffers().isEmpty());
		assertEquals(writeClient.mockedShuffleServer.getFinishBlockSize(), writeClient.mockedShuffleServer.getFlushBlockSize());
	}
	...
	class MockShuffleWriteClient implements ShuffleWriteClient {
		...
		@Override
		public Roaring64NavigableMap getShuffleResultForMultiPart(String clientType, Map<ShuffleServerInfo, Set<Integer>> serverToPartitions, String appId, int shuffleId) {
			return null;
		}
