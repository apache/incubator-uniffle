...
public class LocalOrderSegmentSplitterTest {
  ...
  void testSplitContainsStorageId() {
    ...
    // generate 3 batch segments with storage ID 1, 2, 3 to simulate 3 flush event write 3 index
    // file
    int[] storageIds = new int[] {1, 2, 3};
    byte[] data0 =
        generateData(Pair.of(32, 0), Pair.of(16, 0), Pair.of(10, 0), Pair.of(32, 6), Pair.of(6, 0));
    byte[] data1 =
        generateData(Pair.of(32, 1), Pair.of(26, 1), Pair.of(10, 1), Pair.of(32, 0), Pair.of(6, 1));
    byte[] data2 =
