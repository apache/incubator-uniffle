...
public class ShuffleUploader {
  ...
  public ShuffleUploader(Builder builder) {
    ...
    daemonThread = ThreadUtils.getThreadFactory(localStorage.getBasePath() + " - ShuffleUploader-%d")
        .newThread(runnable);

    executorService = Executors.newFixedThreadPool(
        uploadThreadNum,
        ThreadUtils.getThreadFactory(localStorage.getBasePath() + " ShuffleUploadWorker-%d"));
  }
