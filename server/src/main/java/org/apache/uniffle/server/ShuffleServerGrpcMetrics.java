...
public class ShuffleServerGrpcMetrics extends GRPCMetrics {
  ...
  private static final String GRPC_SEND_SHUFFLE_DATA_SEND_LATENCY = "grpc_send_shuffle_data_send_latency";
  private static final String GRPC_GET_SHUFFLE_DATA_SEND_LATENCY = "grpc_get_local_shuffle_data_send_latency";
  private static final String GRPC_GET_IN_MEMORY_SHUFFLE_DATA_SEND_LATENCY =
      "grpc_get_in_memory_shuffle_data_send_latency";
  ...
  public void registerMetrics() {
    ...
    sendTimeSummaryMap.putIfAbsent(SEND_SHUFFLE_DATA_METHOD,
        metricsManager.addSummary(GRPC_SEND_SHUFFLE_DATA_SEND_LATENCY));
    sendTimeSummaryMap.putIfAbsent(GET_SHUFFLE_DATA_METHOD,
        metricsManager.addSummary(GRPC_GET_SHUFFLE_DATA_SEND_LATENCY));
    sendTimeSummaryMap.putIfAbsent(GET_IN_MEMORY_SHUFFLE_DATA_METHOD,
