...
public class ShuffleServerGrpcMetrics extends GRPCMetrics {
  ...
  private static final String GRPC_SEND_SHUFFLE_DATA_SEND_LATENCY = "grpc_send_shuffle_data_transport_latency";
  private static final String GRPC_GET_SHUFFLE_DATA_SEND_LATENCY = "grpc_get_local_shuffle_data_transport_latency";
