...
public class MutableShuffleHandleInfo extends ShuffleHandleInfoBase {
    ...
    public Map<Integer, List<ShuffleServerInfo>> getPartitionToServers() {
        throw new RssException("Illegal to access this method!");
    }
    ...
    public static RssProtos.ShuffleHandleInfo toProto(MutableShuffleHandleInfo handleInfo) {
    ...
    public static MutableShuffleHandleInfo fromProto(RssProtos.ShuffleHandleInfo handleProto) {
        if (handleProto == null) {
            return null;
        }
