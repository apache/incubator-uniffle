 ...
 */
public class RssShuffleInputGateCommon {

  private static final Logger LOG = LoggerFactory.getLogger(RssShuffleInputGateCommon.class);
  ...
  public RssShuffleInputGateCommon(
