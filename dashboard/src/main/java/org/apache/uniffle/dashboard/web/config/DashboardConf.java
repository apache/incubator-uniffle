...
public class DashboardConf extends RssBaseConf {
  ...
  public static final ConfigOption<Integer> DASHBOARD_HTTP_PORT = ConfigOptions
      .key("rss.dashboard.http.port")
      .intType()
      .defaultValue(19988)
      .withDescription("http server http port");

  public static final ConfigOption<Long> DASHBOARD_STOP_TIMEOUT = ConfigOptions
      .key("rss.dashboard.stop.timeout")
      .longType()
      .defaultValue(30 * 1000L)
      .withDescription("dashboard http server stop timeout (ms) ");

  public static final ConfigOption<Long> DASHBOARD_IDLE_TIMEOUT = ConfigOptions
      .key("rss.dashboard.http.idle.timeout")
      .longType()
      .defaultValue(30 * 1000L)
      .withDescription("dashboard http server http idle timeout (ms) ");

  public static final ConfigOption<Integer> DASHBOARD_CORE_POOL_SIZE = ConfigOptions
      .key("rss.dashboard.corePool.size")
      .intType()
      .defaultValue(256)
      .withDescription("dashboard http server corePool size");

  public static final ConfigOption<Integer> DASHBOARD_MAX_POOL_SIZE = ConfigOptions
      .key("rss.dashboard.maxPool.size")
      .intType()
      .defaultValue(256)
