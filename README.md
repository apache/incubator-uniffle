...
|rss.server.partition.buffer.size|-|Max size of each buffer in buffer manager|
...
|spark.rss.storage.type|-|Supports LOCALFILE, HDFS, LOCALFILE_AND_HDFS, should be the same value in Shuffle server|
