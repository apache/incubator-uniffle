...
public class ServletTest extends IntegrationTestBase {
  ...
  public void testNodesServlet() throws Exception {
    ...
    Response<List<HashMap<String, Integer>>> response = objectMapper.readValue(content,
            new TypeReference<Response<List<HashMap<String, Integer>>>>() {
    });
    List<HashMap<String, Integer>> serverList = response.getData();
    ...
    response = objectMapper.readValue(content, new TypeReference<Response<List<HashMap<String, Integer>>>>() {
    });
