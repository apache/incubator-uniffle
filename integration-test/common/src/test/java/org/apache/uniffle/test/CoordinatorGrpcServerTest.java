...
public class CoordinatorGrpcServerTest {
  ...
  public void testGrpcConnectionSize() throws Exception {
    ...
    double connSize = grpcMetrics.getGaugeMap().get(GRCP_SERVER_CONNECTION_SIZE_TAG).get();
    ...
    connSize = grpcMetrics.getGaugeMap().get(GRCP_SERVER_CONNECTION_SIZE_TAG).get();
