...
public class SparkIntegrationTestBase extends IntegrationTestBase {
  ...
  public static void setUpMRYarn() throws IOException {
    ...
    conf.setFloat("yarn.scheduler.capacity.root.default.user-limit-factor", 1);
    conf.setInt("yarn.scheduler.capacity.root.default.maximum-capacity", 100);
    ...
    conf.setInt("yarn.scheduler.capacity.node-locality-delay", -1);
  ...
  private void runRssApp(Configuration jobConf) throws Exception {
    URL url = SparkIntegrationTestBase.class.getResource("/");
