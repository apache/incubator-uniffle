...
public class MRIntegrationTestBase extends IntegrationTestBase {
  ...
  private void runRssApp(Configuration jobConf, boolean remoteMerge) throws Exception {
    ...
    if (remoteMerge) {
      ...
      jobConf.set(MRConfig.SHUFFLE_CONSUMER_PLUGIN, "org.apache.hadoop.mapreduce.task.reduce.RMRssShuffle");
    } else {
  ...
  protected static void setupServers(Map<String, String> dynamicConf, ShuffleServerConf serverConf) throws Exception {
