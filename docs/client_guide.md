...
|<client_type>.rss.client.io.compression.codec|ZSTD| The compression codec is used to compress the shuffle data. Default codec is `ZSTD`. Other options are`LZ4` and `SNAPPY`.                                                                                                                                                                                                                                                                                                                                                                    |
