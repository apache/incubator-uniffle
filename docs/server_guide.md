...
|rss.server.localstorage.storage.chooser.class|org.apache.uniffle.server.storage.local.HashBasedStorageChooser|For localstorage, the storage chooser is for per-partition. Default value is the hash-based disk selector.|
