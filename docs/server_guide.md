...
| rss.rpc.server.type                                     | GRPC_NETTY                                                             | Shuffle server type, supports GRPC_NETTY, GRPC. The default value is GRPC_NETTY. We recommend to use GRPC_NETTY for better stability and performance.                                                                                                                                                                                                                                        |
...
| rss.server.netty.port                                   | 17000                                                                  | Netty port for Shuffle server, if set zero, Netty server start on random port.                                                                                                                                                                                                                                                                                                               |
| rss.server.netty.epoll.enable                           | false                                                                  | If enabling epoll model with Netty server.                                                                                                                                                                                                                                                                                                                                                   |
...
### Netty
In version 0.8.0, we introduced Netty. Enabling Netty on ShuffleServer can significantly reduce GC time in high-throughput scenarios. Netty is enabled by default.
